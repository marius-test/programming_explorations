...
# settings
text = "Sample Text Here"  # text to convert into ASCII art
img_width = 1920  # width of the final image in pixels
img_height = 1080  # height of the final image in pixels
base_color = np.array([0, 128, 128], dtype=np.float32)  # teal base color as RGB float array

# brightness settings for vignette effect
min_brightness = 0.6  # minimum brightness at edges (closer to 1 means brighter middle)
...
# calculate brightness scale with sharper falloff near edges
...
img.save(r"C:\\Users\\marius\\python\\programming_explorations\\python\\ascii_text_wallpaper_generator\\images\\ascii_vertical_wallpaper_2.png")
